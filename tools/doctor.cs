...
//   7. every README and page    <->  the counts they state     "79 chapters"
...
// ═════════════════════════════════════════════════════════════════════════════
// 11. Counts written into prose: "79 chapters", "464 questions", "362 Golden
        ...
        foreach (string pattern in sentences)
        {
            ...
            foreach ((string path, string body) in files)
            {
                foreach (Match m in rx.Matches(body))
                {
                    ...
                    // quantity — "these fifty-four chapters are not in it" is a
