...
//   7. every README and page    <->  the counts they state     "81 chapters"
...
// ═════════════════════════════════════════════════════════════════════════════
// 11. Counts written into prose: "81 chapters", "1038 questions", "384 Golden
        ...
        foreach (string pattern in sentences)
        {
            ...
            foreach ((string path, string body) in files)
            {
                foreach (Match m in rx.Matches(body))
                {
                    ...
                    // quantity — "these fifty-six chapters are not in it" is a
